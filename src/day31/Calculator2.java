...
public class Calculator2 {
	...
	public static void calculate(char operator,int firstNum, int secNum) {
	    ...
	    switch (operator) {
	    case '+':
	      System.out.println("result of add is : " + (firstNum+secNum));
	      break;
	    case '-':
	      System.out.println("result of sub is : " + (firstNum-secNum));
	      break;
	    case '*':
	      System.out.println("result of mult is : " + (firstNum*secNum));
	      break;
	    case '/':
	      System.out.println("result of div is : " + (firstNum/secNum));
	      break;
	    case '%':
