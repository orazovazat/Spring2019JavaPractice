...
public class StringTask1 {
	...
	public static void main(String[] args) {
	     ...
	     * how do we get last character
	     * index of any String s1.length() -1 
	     * how do we get first character of any String s1.charAt(0) 
	     * WHILE COUNTING EACH AND EVERY CHARACTER COUNTS including space or any other special
	     * Characters
	     * 
	     */
